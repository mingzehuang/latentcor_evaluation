...
load("/scratch/user/sharkmanhmz/latentcor_evaluation_git/latentcor_evaluation/NT_grid.rda")
load("/scratch/user/sharkmanhmz/latentcor_evaluation_git/latentcor_evaluation/NN_grid.rda")

save(BCipol, BBipol, TCipol, TBipol, TTipol, NCipol, NBipol, NTipol, NNipol, file = "all_grid.rda",
     compress = "xz")
