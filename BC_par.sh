...
#SBATCH --job-name=BC_par            #Set the job name to BC_par
#SBATCH --time=0:10:00               #Set the wall clock limit to 10min
#SBATCH --nodes=1                    #Request 1 node
#SBATCH --ntasks-per-node=80         #Request 8 tasks/cores per node
#SBATCH --mem=20GB                     #Request 8GB per node
#SBATCH --output=BCOut.%j            #Send stdout/err to "Example2Out.[jobID]"
