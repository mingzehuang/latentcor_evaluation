...
#SBATCH --job-name=num_eval_nb_par            #Set the job name to BC_par
...
#SBATCH --output=num_eval_nb_par_Out.%j            #Send stdout/err to "Example2Out.[jobID]"
